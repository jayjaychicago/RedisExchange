...
router.get('/graphs.json', function(req, res) {
//      console.log(req);
        var conn = uuid.v1()  + '-GRAPHS-GET' + iConn;
        ...
        if (!req.body.productName || !req.body.exchangeName) {
                ...
                res.end('{"msgType":"ERROR","message":"GET GRAPHS: Either the productName or the exchangeName were empty"}');
        }
        else {
