...
<?php include "sidebar.php" ;?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Completed deals for <?php echo $_GET["product"] ; ?> product</h1>
			</div>
		</div>
		<!--
		<div class="row">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Completed deals history</div>
					<div class="panel-body">
					<div style="width:100%;" id="fillTable"></div>
						<!--
