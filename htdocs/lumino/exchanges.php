...
<title>Instabid - Exchanges</title>
<?php
session_start();
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="/lumino/exchanges.php?exchange=<?php echo $_GET["exchange"]; ?>&product=<?php echo $_GET["product"] ;?>"><span class="glyphicon glyphicon-stats"></span> My exchanges</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">My Exchanges</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Exchanges</h1>
			</div>
		</div><!--/.row-->
	<!--	
		<div class="row">
...
productsToTable(exchange, $("#productList"), 'class="table table-hover gradienttable" data-sort-name="Product Name" data-sort-order="desc"');
});
