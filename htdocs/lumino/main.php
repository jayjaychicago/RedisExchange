...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="widgets.html"><span class="glyphicon glyphicon-th"></span> My products</a></li>
			<li><a href="charts.html"><span class="glyphicon glyphicon-stats"></span> My exchanges</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Widgets / Simple bid collection</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Simple Bid collection</div>
					<div class="panel-body">
					<div style="width:200px; float:left;" id="simpleBidsTable"></div>
					<div style="width:350px; float:right; margin-right:40%;" id="simpleBids"></div>
						<!--
