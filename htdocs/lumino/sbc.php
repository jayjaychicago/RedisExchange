...
jQuery(document).ready(function ($) {
	...
	$("#sbc").css("font-weight","Bold");
	placeSimpleBid("<?php echo $_GET["exchange"] ;?>", "<?php echo $_GET["product"] ;?>", $("#simpleBids"));
	buyNow("<?php echo $_GET["exchange"] ;?>", "<?php echo $_GET["product"] ;?>", $("#buyNow"));
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Bids / Place a bid</li>
			</ol>
		</div>
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Place a bid on <?php echo $_GET["product"] ; ?> product</h1>
			</div>
		</div>
		<!--
		<div class="row">
				...
				<div class="panel panel-default">
					...
					<div>
						<div>
							...
							<div style="width:25%; float:left;" id="simpleBidsTable"></div>
							<div style="width:1%;"></div>
							<div style="width:40%; float:right; margin-right:30%;" id="simpleBids"></div>
							<div style="width:2%;"></div>
						</div>
						<div>
							<div style="width:2%;"></div>
							...
							<div style="width:1%;"></div>
							<div style="width:40%; float:right; margin-right:30%;" id="buyNow"></div>
							<div style="width:2%;"></div>
						</div>
					</div>
						<!--
