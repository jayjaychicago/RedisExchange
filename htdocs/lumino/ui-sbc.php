	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">UI Docs / Place a bid</li>
			</ol>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div style="width:30%; float:left;" id="simpleBidsTable"></div>
					<div style="width:10%;"></div>
					<div style="width:30%; float:right; margin-right:30%;" id="simpleBids"></div>
						<!--
