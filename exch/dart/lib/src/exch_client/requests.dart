...
class Side implements Comparable<Side> {
  ...
  static get values => [BID_SIDE, ASK_SIDE];
...
class CreateMarketReq implements Request {
...
class SubmitReq implements Request {
...
class CancelReq implements Request {
...
class ReplaceReq implements Request {
...
class MarketDetailsReq implements Request {
  const MarketDetailsReq(this.reqId, this.marketId, this.userId, this.startTime,
      this.endTime, this.includeActive, this.includeDead, this.includeFills);
