...
public:
  Book_update_evt(Market_id_t market_id, Side side, Price_t price,
      ...
      : market_id_{ market_id }, side_{ side }, price_{ price },
        quantity_{ quantity }, top_price_{ top_price } {}
...
class Trade_evt {
public:
  Trade_evt(Market_id_t market_id, Side side, Quantity_t quantity,
            Price_t price, Quantity_t net_volume)
      : market_id_{ market_id }, side_{ side }, quantity_{ quantity },
        price_{ price }, net_volume_{ net_volume } {}
